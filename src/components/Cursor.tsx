...
//       <div
//         ref={cursorRef}
//         className="fixed top-0 left-0 w-2 h-2 bg-[#281464] rounded-full pointer-events-none z-[9999]"
//       />
//       <div
//         ref={followerRef}
//         className="fixed top-0 left-0 w-8 h-8 bg-[#281464] rounded-full pointer-events-none z-[9998] mix-blend-difference"
//       />
//     </>
//   );
// };
...
const Cursor: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        ref={cursorRef}
        className="fixed top-0 left-0 w-2 h-2 bg-[#281464] rounded-full pointer-events-none z-[9999] -translate-x-1/2 -translate-y-1/2"
      />
      {/* Outer Follower Circle */}
      <div
        ref={followerRef}
        className={`fixed top-0 left-0 rounded-full border border-[#281464]/50 pointer-events-none z-[9998] -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ease-out ${
          isHovering ? "w-16 h-16 bg-[#281464]/10 border-[#281464]" : "w-10 h-10"
        }`}
      />
    </>
  );
...
//         gsap.set(text, { x: mouseX, y: mouseY });
//       }
//     });
...
//       <div
//         ref={blobRef}
//         className="fixed top-0 left-0 w-14 h-14 bg-[#281464] rounded-full pointer-events-none z-[9998] blur-[1px]"
//         style={{
...
//       <div
//         ref={textRef}
//         className="fixed top-0 left-0 text-white text-xs font-bold uppercase tracking-widest pointer-events-none z-[10000] opacity-0"
